...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        nggettext_extract: {
            pot: {
                files: {
                    'po/template.pot': ['<%= yeoman.client %>/{app,components}/**/*.html', '<%= yeoman.client %>/{app,components}/**/*.controller.js']
                }
            },
        },
        nggettext_compile: {
            all: {
                files: {
                    '<%= yeoman.client %>/components/translations/translations.js': ['po/*.po']
                }
            },
        },
        yeoman: {
        ...
        rev: {
            dist: {
                files: {
                    src: ['<%= yeoman.dist %>/public/{,*/}*.js', '!<%= yeoman.dist %>/public/bower_components/spin.js', '<%= yeoman.dist %>/public/{,*/}*.css', '<%= yeoman.dist %>/public/assets/images/{,*/}*.{png,jpg,jpeg,gif,webp,svg}', '<%= yeoman.dist %>/public/assets/fonts/*/*']
                }
            }
        },
        ...
        //The following *-min tasks produce minified files in the dist folde
        ...
        copy: {
            dist: {
                files: [{
                    ...
                    expand: true,
                    cwd: '<%= yeoman.client %>/',
                    src: 'google55c4d0259b834fce.html',
                    dest: '<%= yeoman.dist %>/public'
                }]
            },
            styles: {
    ...
    grunt.registerTask('build', ['clean:dist', 'concurrent:dist', 'injector', 'wiredep', 'useminPrepare', 'autoprefixer', 'ngtemplates', 'concat', 'ngAnnotate', 'copy:dist', 'cdnify', 'cssmin', 'uglify', 'rev', 'usemin', 'nggettext_extract', 'nggettext_compile']);
