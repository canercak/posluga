...
var sendMail = function(user, pass, callback) {
    ...
    var loginlocals = {
        ...
        TEXT1X: gt.gettext('Welcome to Posluga.ua. We have created an account for you to give price quotes to the business opportunities we send to you. When you receive a business opportunity email from us, use the below login details to enter the system and give price quotes.'),
    ...
    service.sendmail('loginprovider', user, gt.gettext('Your Login Details'), loginlocals, callback);
};
